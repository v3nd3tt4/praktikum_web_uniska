...
<div class="col-sm-9">
	...
	<form action="" class="form-horizontal" method="POST">
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <input type="text" name="nik" class="form-control" value="" maxlength="10" placeholder="NIK" required>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="date" name="tanggal_lahir" class="form-control input-group" placeholder="NIK" value="" required>
            </div>
        </div>
        <div class="form-group">
            <label for="" class="col-sm-3 control-label">Alamat</label>
            <div class="col-sm-3">
                <textarea name="alamat" class="form-control input-group" placeholder="Alamat" value="" required></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="" class="col-sm-3 control-label">Nomor Telepon</label>
            <div class="col-sm-3">
                <input type="text" name="no_telepon" class="form-control input-group" maxlength="12" value="" placeholder="Nomor Telepon" required>
            </div>
        </div>
        <div class="form-group">
